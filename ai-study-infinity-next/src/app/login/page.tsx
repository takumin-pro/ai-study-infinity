  ...
  return (
    <div className={styles.container}>
      <div className={styles.card}>
        <h1 className={styles.title}>オンライン塾 ログイン</h1>
        <p className={styles.subtitle}>学習ダッシュボードへアクセス</p>
        ...
        <form action={login} onSubmit={() => setIsPending(true)} className={styles.form}>
